    ...
    try {
      const response = await axios(
        `https://api.escuelajs.co/api/v1/products${
          id
            ? `/${id}`
            : `?offset=${page}&limit=${5}&title=${titulo}&categorySlug=${categoria.toLowerCase()}`
        }`
      );
  ...
  return (
    <div className="p-4 ">
      <div className="d-flex justify-content-between ">
        ...
        <Link to={"/cadastrar-produtos"} className="btn btn-success">
          Cadastrar Produto
        </Link>
      </div>
          ...
          <Row className=" ">
            <Col className="col-12 col-lg-6 mb-4 mb-lg-0">
              ...
              <input
                className="form-control input-size"
                disabled
                placeholder="Pesquise pelo preço"
                type="text"
              />
            </Col>
              ...
              <tr className="p-5">
                ...
                <td className="p-4">
                  <img
                    ...
                    className=" rounded-1 col-12 col-lg-6 border "
                    src={item.images[0] || ""}
                    alt=""
                  />
                </td>
                ...
                <td className="p-4 text-truncate ">
                  R$ {Number(item.price).toFixed(2)}
                </td>
                <td className="p-4 ">
                  <div className="mb-5 d-flex gap-2">
                    <Link
                      to={`/editar-produtos/${item.id}`}
